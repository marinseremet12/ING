...
class BuyEasy extends React.Component {
    ...
    async handleBuyEasy() {
        ...
        const { value: easyAmount } = await Swal.fire({
            ...
            html: 'Current exchange rate:<br>1 ETH&nbsp;=&nbsp;<b>' + this.props.ETH_TO_EASY + '&nbsp;IGL</b>. <p>How many IGL do you want to purchase</p>'
        })
        ...
        if (easyAmount) {
            ...
            Swal.fire({
                ...
                html: '<p>Are you sure you want to purchase <b>' + easyAmount + '&nbsp;IGL</b>?<p>It will cost ' + ethAmount + '&nbsp;ETH</p>'
            }).then(result => {
            ...
            .then(
                result => {
                    Swal.fire({
                        ...
                        html: "Congradulation! You have purchased <b>" + easyAmount + "&nbsp;IGL</b>!<p>Add IGL smartcontract address <b>" + myConfig.CONTRACT_ADDRESS_EASYCOIN + "</b> to&nbsp;your BSC wallet</p><p>Current page will be reloaded</p>"
                    }).then((result) => {
